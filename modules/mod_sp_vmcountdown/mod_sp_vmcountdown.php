...
foreach ($products as &$product) {
	$product->image = (isset($product->images[0]) && $product->images[0]) ? $product->images[0]->displayMediaFull ('class="ProductImage"', FALSE) : '' ; 
...
require JModuleHelper::getLayoutPath('mod_sp_vmcountdown', $params->get('layout'));