    ...
    <head>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                <?php
                $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, megedeal-icon.css') // CSS Files
                        ->addJS('bootstrap.min.js, jquery.sticky.js, jquery.countdown.min.js, main.js') // JS Files
