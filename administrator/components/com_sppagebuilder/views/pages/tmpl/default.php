				...
				<?php if (!$this->params->get('joomshaper_license_key') || !$this->params->get('gmap_api')) { ?>
					<div class="sp-pagebuilder-message-container">
						<div class="alert alert-warning">
							<div class="row-fluid">
								<div class="span10 sp-pagebuilder-message-text">
									<h4 class="alert-heading"><?php echo JText::_('COM_SPPAGEBUILDER_GLOBAL_WARNING') ?></h4>
									<?php if(!$this->params->get('joomshaper_license_key')) { ?>
										<div class="alert-message"><?php echo JText::_('COM_SPPAGEBUILDER_LICENSE_NOT_FOUND') ?></div>
									<?php } ?>
									<?php if(!$this->params->get('gmap_api')) { ?>
										<div class="alert-message"><?php echo JText::_('COM_SPPAGEBUILDER_GMAP_API_NOT_FOUND') ?></div>
									<?php } ?>
								</div>
								<div class="span2 sp-pagebuilder-message-button">
									<a href="<?php echo JRoute::_('index.php?option=com_config&view=component&component=com_sppagebuilder&path=&return=' . urlencode(base64_encode(JUri::getInstance())));?>" class="sp-pagebuilder-btn sp-pagebuilder-btn-success sp-pagebuilder-btn-sm"><?php echo JText::_('COM_SPPAGEBUILDER_GLOBAL_UPDATE') ?></a>
								</div>
							</div>
						</div>
					</div>
